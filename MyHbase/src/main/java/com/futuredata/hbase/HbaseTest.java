...
//		insertData();
	...
	public static void insertData() throws Exception {
		...
		Put put = new Put(Bytes.toBytes("row0001"));
		put.add(Bytes.toBytes("info"), Bytes.toBytes("id"), Bytes.toBytes("001"));
		put.add(Bytes.toBytes("info"), Bytes.toBytes("name"), Bytes.toBytes("wang xue"));
		table.put(put);
		table.close();
	}
